...
Rarefied gas dynamics studies gas and plasma flows with low densities where the mean free path is significant compared to the flow characteristic spatial dimension, making the use of kinetic equations necessary and surface interactions crucial. The central characteristic number relevant to these processes is the Knudsen number, a ratio of the mean free path to a characteristic spatial dimension, which defines flow regimes from continuum flow to free molecule flow, where molecular behavior dominates.
